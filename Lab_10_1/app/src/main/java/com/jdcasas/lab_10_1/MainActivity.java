...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnActualizar = (Button) findViewById(R.id.BotonActivar);
        btnDesactivar = (Button) findViewById(R.id.BotonDesactivar);
        lblLatitud = (TextView) findViewById(R.id.TextViewLatitud);
        lblLongitud = (TextView) findViewById(R.id.TextViewPosLongitud);
        lblPrecision = (TextView) findViewById(R.id.TextViewPresicion);
        lblEstado = (TextView) findViewById(R.id.TextViewEstado);
